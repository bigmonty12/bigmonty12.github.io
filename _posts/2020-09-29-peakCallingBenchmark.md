...
### Data Analysis
PR (precision-recall) curves were generated in R. The function `AUC` from the library `DescTools` was used to calculate the area under the curve for each curve. Graphs were created in R using ggplot. [Rscript](https://github.com/bigmonty12/peakCallingBenchmark/blob/master/peakBenchmarkStats.R) can be found on Github.
## Results
### Precision-Recall
...
| ![Original Coverage](/assets/photos/original-bp-coverage.png) |
|:--:|
